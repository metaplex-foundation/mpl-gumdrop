# JavaScript client for Mpl Gumdrop
...
2. Next, install this library using the package manager of your choice.
   ```sh
   npm install @metaplex-foundation/mpl-gumdrop
   ```
2. Finally, register the library with your Umi instance like so.
   ```ts
   import { mplGumdrop } from '@metaplex-foundation/mpl-gumdrop';
   umi.use(mplGumdrop());
   ```

You can learn more about this library's API by reading its generated [TypeDoc documentation](https://mpl-gumdrop-js-docs.vercel.app).
