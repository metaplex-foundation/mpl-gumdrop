...
impl ClaimCandy {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ClaimCandyInstructionData::new().try_to_vec().unwrap();
...
impl ClaimCandyInstructionData {
    fn new() -> Self {
        Self {
...
pub struct ClaimCandyInstructionArgs {
    pub wallet_bump: u8,
    pub claim_bump: u8,
    pub index: u64,
    pub amount: u64,
...
/// Instruction builder for `ClaimCandy`.
///
/// ### Accounts:
///
///   0. `[writable]` distributor
///   1. `[writable]` distributor_wallet
///   2. `[writable]` claim_count
///   3. `[signer]` temporal
///   4. `[signer]` payer
///   5. `[]` candy_machine_config
///   6. `[writable]` candy_machine
///   7. `[writable]` candy_machine_wallet
///   8. `[writable]` candy_machine_mint
///   9. `[writable]` candy_machine_metadata
///   10. `[writable]` candy_machine_master_edition
...
///   14. `[optional]` candy_machine_program (default to `CndyV3LdqHUfDLmE5naZjVN8rBZz4tqhdefbAnjHG3JR`)
///   15. `[optional]` rent (default to `SysvarRent111111111111111111111111111111111`)
///   16. `[]` clock
#[derive(Default)]
pub struct ClaimCandyBuilder {
...
impl ClaimCandyBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = ClaimCandyInstructionArgs {
...
/// `claim_candy` CPI accounts.
pub struct ClaimCandyCpiAccounts<'a, 'b> {
    /// The [MerkleDistributor].
...
/// `claim_candy` CPI instruction.
pub struct ClaimCandyCpi<'a, 'b> {
    ...
    pub __args: ClaimCandyInstructionArgs,
}

impl<'a, 'b> ClaimCandyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ClaimCandyCpiAccounts<'a, 'b>,
        args: ClaimCandyInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ClaimCandy` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` distributor
...
///   14. `[]` candy_machine_program
///   15. `[]` rent
///   16. `[]` clock
pub struct ClaimCandyCpiBuilder<'a, 'b> {
    instruction: Box<ClaimCandyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimCandyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClaimCandyCpiBuilderInstruction {
            __program: program,
            distributor: None,
...
struct ClaimCandyCpiBuilderInstruction<'a, 'b> {
